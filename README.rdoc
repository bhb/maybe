...
This is especially handy for long chains of method calls, any of which could return nil.
   ...
   # foo, bar, and/or baz could return nil, but this will
   # still work
...
* MenTaLguY has a great tutorial on Monads in Ruby over at Moonbase[link:http://moonbase.rydia.net/mental/writings/programming/monads-in-ruby/00introduction.html]
* Oliver Steele explores the problem in depth and looks at a number of different solutions[link:http://osteele.com/archives/2007/12/cheap-monads]
* Reg Braithwaite explores this same problem and comes up with a different, but very cool solution in Ruby[link:http://weblog.raganwald.com/2008/01/objectandand-objectme-in-ruby.html]
* Weave Jester has another solution, inspired by the Maybe monad[link:http://weavejester.com/node/10]
